library draggable_scrollable_sheet;
...
class DraggableScrollableSheetResetter extends StatelessWidget {
  ...
  DraggableScrollableSheetResetter({Key key, @required this.child})
      : super(key: key);
  ...
  static bool reset(BuildContext context) {
    final _InheritedResetNotifier notifier =
        context.inheritFromWidgetOfExactType(_InheritedResetNotifier);
    if (notifier == null) {
      return false;
    }
